...
def fname_Quenched(NN, noise_parm, initial_pos, target_position, left_boundary, right_boundary, nruns):
    return '../Results_Quenched/N_'+str(NN)+'_noise_'+format(noise_parm, '.5f')+'_init_'+str(initial_pos)+'_target_'+str(target_position)+'_left_'+str(left_boundary)+'_right_'+str(right_boundary)+'_nrun_'+str(nruns)
...
# plt.semilogx(noise_parm_list, mfpt_bl, marker = 'o', markersize = 10, lw = 0, label = r'BL')
# plt.semilogx(noise_parm_list, mfpt_resh, marker = 'x', markersize = 10, lw = 0, label = r'Resh')
# plt.semilogx(noise_parm_list, mfpt_quenched, marker = 's', markersize = 10, lw = 0, label = r'Quench')

# plt.loglog(noise_parm_list, mfpt_bl, marker = 'o', markersize = 10, lw = 0, label = r'BL')
# plt.loglog(noise_parm_list, mfpt_resh, marker = 'x', markersize = 10, lw = 0, label = r'Resh')
# plt.loglog(noise_parm_list, mfpt_quenched, marker = 's', markersize = 10, lw = 0, label = r'Quench')
...
plt.savefig('FPT_Moments_vs_Noise.png', bbox_inches='tight')
